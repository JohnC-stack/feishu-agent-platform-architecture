...
项目已经进入实施阶段。P0 工程基线、P1 飞书接入 PoC、P2 调度与数据、P3 执行器层和 P4 企业系统只读接入均已完成验收并关闭；P5 治理与审批已通过本地与真实联调，等待提交、推送及远端 CI/Security 后正式关闭。已完成内容包括：
...
| P5   | 第 11–13 周 | RBAC、审批、配额和审计，待远端门禁       |
...
P0、P1、P2、P3、P4 已关闭。P5 治理、审批、预算、审计、Windows 凭据引用以及真实飞书审批卡片 WSS 全链路均已通过；卡片终态刷新、内容保留、中文状态和北京时间格式已完成回归。等待提交、推送和远端 CI/Security 门禁后正式关闭。P6 尚未开始；详见 [P5 治理与审批](docs/p5-governance-and-approval.md)。
